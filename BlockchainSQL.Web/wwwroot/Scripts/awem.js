awem = function ($) {
    ...
    function dropmenu(o) {
        ...
        function lay() {
            var maxph = maxDropdownHeight;
            if (maxh != null) {
                maxph = maxh;
                if (!maxh) maxph = $(window).height();
            }
            ...
            if ($dropmenu.hasClass('open')) {
                ...
                layDropdownPopup2(o, $dropmenu, isFixed, null, olc, setHeight, 0, 0, chkfulls, isCombo ? comboMinh : menuMinh, 0, maxph, 0, popt && popt.xy);
    ...
    function odropdown(o, opt) {
        ...
        var noClearCache = readTag(o, 'Ncc');
