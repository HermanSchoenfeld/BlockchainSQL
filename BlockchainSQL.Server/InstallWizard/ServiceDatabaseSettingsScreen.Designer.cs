...
namespace BlockchainSQL.Server {
	partial class ServiceDatabaseSettingsScreen {
		/// <summary> 
		...
		private void InitializeComponent() {
			this._blockchainDatabaseSettingsControl = new BlockchainSQL.Server.ServiceDatabaseSettingsControl();
			...
			this._blockchainDatabaseSettingsControl.Padding = new System.Windows.Forms.Padding(8);
			this._blockchainDatabaseSettingsControl.Size = new System.Drawing.Size(532, 278);
			...
			this._groupBox.Size = new System.Drawing.Size(540, 304);
			...
			this.Name = "DatabaseSettingsScreen";
		...
		private ServiceDatabaseSettingsControl _blockchainDatabaseSettingsControl;
