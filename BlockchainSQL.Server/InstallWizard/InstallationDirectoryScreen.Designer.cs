...
namespace BlockchainSQL.Server {
	partial class InstallationDirectoryScreen {
		/// <summary> 
		...
		private void InitializeComponent() {
			...
			// _groupBox
			// 
			this._groupBox.Controls.Add(this._startServiceCheckBox);
			...
			this._groupBox.Size = new System.Drawing.Size(668, 202);
			...
			this._installDirLabel.Location = new System.Drawing.Point(73, 160);
			this._installDirLabel.Name = "_installDirLabel";
			this._installDirLabel.Size = new System.Drawing.Size(276, 15);
			this._installDirLabel.TabIndex = 17;
			this._installDirLabel.Text = "Installation Directory: <<installation directory>>";
			...
			this._createServiceFolderCheckBox.Location = new System.Drawing.Point(73, 89);
			this._createServiceFolderCheckBox.Name = "_createServiceFolderCheckBox";
			this._createServiceFolderCheckBox.Size = new System.Drawing.Size(141, 19);
			this._createServiceFolderCheckBox.TabIndex = 16;
			this._createServiceFolderCheckBox.Text = "Create sub-folder \'{0}\'";
			...
			this._pathSelector.Size = new System.Drawing.Size(577, 38);
			this._pathSelector.TabIndex = 14;
			this._pathSelector.UpdateModelOnStateChanged = false;
			// 
			// label7
			// 
			...
			// 
			// _startServiceCheckBox
			// 
			this._startServiceCheckBox.AutoSize = true;
			this._startServiceCheckBox.Checked = true;
			this._startServiceCheckBox.CheckState = System.Windows.Forms.CheckState.Checked;
			this._startServiceCheckBox.Location = new System.Drawing.Point(73, 123);
			this._startServiceCheckBox.Name = "_startServiceCheckBox";
			this._startServiceCheckBox.Size = new System.Drawing.Size(230, 19);
			this._startServiceCheckBox.TabIndex = 18;
			this._startServiceCheckBox.Text = "Start Windows Service after installation";
			this._startServiceCheckBox.UseVisualStyleBackColor = true;
			// 
			...
			this.Name = "InstallationDirectoryScreen";
			this.Size = new System.Drawing.Size(668, 202);
		...
		private System.Windows.Forms.CheckBox _startServiceCheckBox;
	}
}
